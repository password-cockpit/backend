<?php
/**
 * @see       https://github.com/expressive/expressive-router for the canonical source repository
 * @copyright Copyright (c) 2018 Zend Technologies USA Inc. (https://www.zend.com)
 * @license   https://github.com/expressive/expressive-router/blob/master/LICENSE.md New BSD License
 */
